  ...
  romeoAndJuliet: {
    ...
    factions: {
      montagues: {
        ...
        generalRoles: [
          { name: 'Montague Servant', startingCoins: 30, startingWeapons: [], startingMercenaries: 0, startingCastles: 0, personality: 'loyal' },
          { name: 'Montague Guard', startingCoins: 40, startingWeapons: ['sword'], startingMercenaries: 0, startingCastles: 0, personality: 'protective' },
          { name: 'Montague Ally', startingCoins: 35, startingWeapons: [], startingMercenaries: 1, startingCastles: 0, personality: 'supportive' }
        ]
      },
      capulets: {
        ...
        generalRoles: [
          { name: 'Capulet Servant', startingCoins: 30, startingWeapons: [], startingMercenaries: 0, startingCastles: 0, personality: 'loyal' },
          { name: 'Capulet Guard', startingCoins: 40, startingWeapons: ['sword'], startingMercenaries: 0, startingCastles: 0, personality: 'protective' },
          { name: 'Capulet Ally', startingCoins: 35, startingWeapons: [], startingMercenaries: 1, startingCastles: 0, personality: 'supportive' }
        ]
      }
    },
    neutralTerritories: [
      { name: 'Verona Square', cost: 90, description: 'Central marketplace and gathering place, very high strategic value' },
      { name: 'Friar Laurence\'s Cell', cost: 85, description: 'Sacred sanctuary and neutral ground, high strategic value' },
    ...
    factions: {
      fellowship: {
        ...
        territories: [
          ...
          { name: 'Bree', cost: 70, description: 'Crossroads town and meeting place' },
          { name: 'Weathertop', cost: 65, description: 'Ancient watchtower and strategic point' },
          { name: 'Fangorn Forest', cost: 60, description: 'Ent realm and natural fortress' },
          { name: 'Edoras', cost: 55, description: 'Rohan\'s capital and horse country' }
        ],
        characters: [
          {
            name: 'Frodo Baggins',
            ...
            quotes: [
              ...
              "I am Frodo Baggins, and I will destroy the Ring.",
              "The Ring is mine!",
              "I will go alone if I must."
            ],
            description: 'Brave hobbit who carries the One Ring to Mount Doom.'
          }
        ],
        generalRoles: [
          { name: 'Fellowship Member', startingCoins: 30, startingWeapons: [], startingMercenaries: 0, startingCastles: 0, personality: 'loyal' },
          { name: 'Elven Warrior', startingCoins: 40, startingWeapons: ['bow'], startingMercenaries: 0, startingCastles: 0, personality: 'noble' },
          { name: 'Gondor Soldier', startingCoins: 35, startingWeapons: ['sword'], startingMercenaries: 1, startingCastles: 0, personality: 'brave' }
        ]
      },
      mordor: {
        ...
        territories: [
          { name: 'Mount Doom', cost: 100, description: 'Volcano where the Ring was forged' },
          { name: 'Barad-dûr', cost: 95, description: 'Sauron\'s dark tower and fortress' },
          { name: 'Minas Morgul', cost: 90, description: 'Fallen city and Nazgûl stronghold' },
          { name: 'Cirith Ungol', cost: 85, description: 'Spider\'s lair and treacherous pass' },
          { name: 'Udûn', cost: 80, description: 'Valley of fire and orc breeding ground' },
          { name: 'Gorgoroth', cost: 75, description: 'Plains of Mordor and battlefield' },
          { name: 'Nurn', cost: 70, description: 'Slave fields and resource center' },
          { name: 'Dol Guldur', cost: 65, description: 'Necromancer\'s fortress in Mirkwood' },
          { name: 'Isengard', cost: 60, description: 'Saruman\'s tower and orc factory' },
          { name: 'Moria', cost: 55, description: 'Ancient dwarven city and orc stronghold' }
        ],
        characters: [
          {
            name: 'Sauron',
            role: 'Dark Lord',
            startingCoins: 150,
            startingWeapons: ['One Ring'],
            startingMercenaries: 5,
            startingCastles: 4,
            personality: 'evil',
            quotes: [
              "I am Sauron, the Dark Lord!",
              "I will rule Middle-earth!",
              "I am the most powerful being!",
              "I will corrupt all who oppose me!",
              "I am the master of the Ring!"
            ],
            description: 'The Dark Lord who seeks to conquer Middle-earth.'
          }
        ],
        generalRoles: [
          { name: 'Orc Warrior', startingCoins: 30, startingWeapons: [], startingMercenaries: 0, startingCastles: 0, personality: 'aggressive' },
          { name: 'Nazgûl', startingCoins: 40, startingWeapons: ['sword'], startingMercenaries: 0, startingCastles: 0, personality: 'fearful' },
          { name: 'Uruk-hai', startingCoins: 35, startingWeapons: ['sword'], startingMercenaries: 1, startingCastles: 0, personality: 'brutal' }
        ]
      }
    },
    neutralTerritories: [
